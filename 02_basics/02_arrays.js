...
// const all_new_heros = [...marvel_heros, ...dc_heros]; // Spreads all indexes of marvel_heros and dc_heros. It is little bit same as concat() but the advantage of this you can spread many arrays list.
